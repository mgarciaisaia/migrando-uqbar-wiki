...
El forall recibe dos parámetros, los dos deben ser consultas. Las consultas se hacen sobre predicados, o sea que forall es un predicado de [orden superior](orden-superior.md), porque puede manejar predicados dentro de sus parámetros.
...
Claro, no es lo que queremos. Para lograr lo que queremos, tenemos que lograr que la variable P llegue ligada al forall mediante [ generación](paradigma-logico---generacion.md):
