...
Claro, no es lo que queremos. Para lograr lo que queremos, tenemos que lograr que la variable P llegue ligada al forall mediante [Paradigma Lógico - generación](generacion.md):
