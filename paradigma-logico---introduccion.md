...
Con esto claro, podemos pasar a ver algunas [definiciones](paradigma-logico---un-poco-de-nomenclatura-consultas.md)

Estos son los conceptos principales de los que se compone un programa Prolog. Para obtener resultados a partir de un programa, hacemos [consultas](paradigma-logico-tipos-de-consulta.md).
