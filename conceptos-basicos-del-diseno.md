...
Un requerimiento es algo que el sistema debe hacer para lograr el objetivo de un usuario. [ Mas sobre requerimientos](http---uqbar-wiki-org-index-php-title-conceptos-de-ingenier-c3-ada-de-software-y-de-sistemas-requerimientos.md)
