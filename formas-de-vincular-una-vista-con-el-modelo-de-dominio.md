...
Es decir, describir [Declaratividad](declarativamente.md) En lugar de escribir código que tome los valores contenidos en la vista *a mano* se intentará describir esa vinculación y permitir que se produzca de forma automática, ante cada acción del usuario.
