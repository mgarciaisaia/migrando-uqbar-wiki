...
Realización: se establece entre una clase y una [interfaz](interfaz.md); esto implica que la clase debe implementar todas las operaciones que defina la interfaz.
