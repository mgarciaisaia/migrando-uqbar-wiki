...
Fíjense que es un objeto que tiene una [ única responsabilidad](http---en-wikipedia-org-wiki-single-responsibility-principle.md) bien identificada. Dado un objeto que le paso por parámetro me sabe decir si cumple o no con la condición.
