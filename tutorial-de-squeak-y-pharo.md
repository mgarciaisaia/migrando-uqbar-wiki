...
Para crear una subclase pueden cambiar el template para que use la superclase en vez de Object. Más detalles, acá: [Cómo crear una subclase en Squeak](como-crear-una-subclase-en-squeak.md)
...
2) En el File Browser van a ver tres paneles:el de la izquierda muestra el arbol de directorios y carpetas de su sistema.[1](http://dl.dropbox.com/u/31270395/UTN/filebrowser.png)
