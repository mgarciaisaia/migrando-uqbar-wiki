...
-   **Dominio**: son las abstracciones que tienen significado para el que conoce el [negocio](definiciones-iniciales-de-ui--que-es-el-modelo-de-dominio-.md) (una factura, un alumno, un proveedor, una encuesta de satisfacción de servicio, etc.)
