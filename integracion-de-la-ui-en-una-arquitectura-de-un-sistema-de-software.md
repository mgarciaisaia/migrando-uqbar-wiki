...
En definitiva pareciera que la vista no se mezcla con el negocio pero el [acoplamiento](conceptos-basicos-del-diseno-acoplamiento.md) es claro: para saber cuándo fue la última vez que le pagué el sueldo necesito:
