...
-   **Radio buttons**: alternativa visual al combo box para seleccionar un conjunto acotado de opciones (Ej: una película puede ser cortometraje, largometraje o documental, un socio puede ser de categoría menor, activo, jubilado o dado de baja).
...
-   **Frame/Group/Tab/Panel/Form**: son controles contenedores de otros controles
