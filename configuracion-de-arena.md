...
Asumimos que tenés instaladas las herramientas básicas según se explica en [Preparacion de un entorno de desarrollo Java](preparacion-de-un-entorno-de-desarrollo-java.md), incluyendo Maven.
