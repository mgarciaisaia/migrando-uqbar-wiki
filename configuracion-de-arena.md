...
Recordamos que deben trabajar con el parent-project [Integración con Xtend](especifico.md). Esto evita tener que agregar manualmente la dependencia. En caso de ser necesario, te dejamos un ejemplo posible para el pom.xml:
