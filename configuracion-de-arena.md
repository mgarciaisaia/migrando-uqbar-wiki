...
Asumimos que además del entorno básico ya te instalaste Scala según el instructivo para [Preparacion de un entorno de desarrollo Scala](preparacion-de-un-entorno-de-desarrollo-scala.md).
...
Las instrucciones para tener un proyecto Scala que utilice Arena son las mismas que para cualquier [Proyecto Maven con Scala](preparacion-de-un-entorno-de-desarrollo-scala-creacion-de-un-proyecto-maven-con-scala.md)
...
Asumimos que además del entorno básico ya te instalaste Xtend según [este instructivo](preparacion-de-un-entorno-de-desarrollo-xtend.md).
...
Recordamos que deben trabajar con el parent-project [específico](configuracion-de-arena-qu-c3-a9-debe-tener-un-pom-xml-de-arena.md). Esto evita tener que agregar manualmente la dependencia. En caso de ser necesario, te dejamos un ejemplo posible para el pom.xml:
...
Asumimos que además del entorno básico ya te instalaste Groovy según [este instructivo](preparacion-de-un-entorno-de-desarrollo-groovy.md).
...
Revisá que Maven esté correctamente instalado en tu máquina y que tenés el settings.xml correctamente configurado. Cualquier duda fijate en [el tutorial de instalación de Maven](preparacion-de-un-entorno-de-desarrollo-java-maven.md).
