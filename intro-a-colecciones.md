...
También sabemos que en Smalltalk todo objeto es instancia de una clase, entonces va a haber una clase Collection. En realidad hay toda una jerarquía con [distintos “sabores”](sabores-de-colecciones.md), distintos tipos de colecciones que nos van a servir para distintos fines.
...
Los objetos que representan "cachos de código" son los [Bloques](bloques.md), en este caso un bloque con un parámetro. Queda así:
